$( window ).load(function(){
    ...
    slider.each( function(){
        new AresSlider2( {
            ...
            items: $(this).find( '.ares-slider_item' ),
            visibleCount: 3,
    ...
    core: function(){
        ...
        return {
            normalWiew: function(){
                ...
                self.visibleCount = ( Math.floor( curWidth / 151 ) > countItems )?countItems: Math.floor( curWidth / 151 );
                self.indent = Math.floor( ( curWidth - (self.visibleCount * 146) ) / ( self.visibleCount - 1 ) );
