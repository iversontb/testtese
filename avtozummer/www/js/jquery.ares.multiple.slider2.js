    ...
    core: function(){
        ...
        return {
            normalWiew: function(){
                ...
                self.visibleCount = ( Math.floor( curWidth / 198 ) > countItems )?countItems: Math.floor( curWidth / 198 );
                self.indent = Math.floor( ( curWidth - (self.visibleCount * 195) ) / ( self.visibleCount - 1 ) );
