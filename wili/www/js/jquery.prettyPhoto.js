...
(function($) {
			...
			$pp_pic_holder.fadeIn(function(){
				...
				switch(_getFileType(pp_images[set_position])){
					...
					case 'youtube':
						...
						(getParam('data-gal',pp_images[set_position])) ? movie+="../../www.apple.com/qtactivex/qtplugin.cab/@data-gal="+getParam('data-gal',pp_images[set_position]) : movie+="@data-gal=1";
	...
	/*-----------------------------------------------------------*/
	/*Для правильного страничного возврата по стрелкам в браузере использовать либо этот код, взамен верхних строчек*/
	/*либо код в самом низу*/
	/*-----------------------------------------------------------*/
	/*function getHashtag(){
		return false;
	};
...
/*-----------------------------------------------------------*/ 
/*Для правильного страничного возврата по стрелкам в браузере*/
/*-----------------------------------------------------------*/ 
