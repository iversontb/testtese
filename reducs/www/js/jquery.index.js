$(function(){
    ...
    $(window).load(function () {
        $('.question_block').height($('.news__gall').height()-20);
        $('.konkurs').height($('.videoBlock').height()-16);
    });

    var curHeight = $('.tabs_gall').width() * 0.8;
    $('.tabs_gall').height( curHeight );
    ...
    core: function(){
        ...
        return {
            build: function(){
                ...
                points.css( { left: ( 964 - points.width() ) / 2 } );
