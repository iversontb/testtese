$( window ).load(function(){
    var slider = $( '.ares-multiple-slider' );

    new AresSlider2( {
        obj: slider,
        btnPrev: slider.find( '.ares-multiple-slider__prev' ),
        btnNext: slider.find( '.ares-multiple-slider__next' ),
        items: slider.find( '.ares-multiple-slider__item' ),
